...
class GnnOPSelector : public NextSelector {
 public:
  explicit GnnOPSelector(PlannerI& planner);  // NOLINT
 ...
 protected:
  static ModuleFactoryRegistry::Registration<GnnOPSelector> registration;
